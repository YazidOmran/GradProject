...
layout = [[sg.Button('STARTCAP', key="-startcap-", button_color='#20222F'),
		sg.Button('STOPCAP', key='-stopcap-', button_color='#20222F'), sg.Button('SAVE ALERT', key='-savepcap-', button_color='#20222F'),
        sg.Button('REFRESH RULES', key='-refreshrules-', button_color='#20222F'),
        sg.Button('LOAD TCP/HTTP2 STREAMS', key='-showtcpstreamsbtn-', button_color='#20222F'),
        sg.Button('LOAD HTTP STREAMS', key='-showhttpstreamsbtn-', button_color='#20222F'),],
        [sg.Text("ALERT PACKETS", font=('Arial Bold', 14), size=(60, None), justification="left",background_color='#10111A'),
         sg.Text("ALL PACKETS", font=('Arial Bold', 14), size=(60, None), justification="left",background_color='#10111A')],
		[sg.Listbox(key='-pkts-', size=(100,20), values=suspiciouspackets, enable_events=True, background_color='#20222F',text_color='white'), 
        sg.Listbox(key='-pktsall-', size=(100,20), values=pktsummarylist, enable_events=True, background_color='#20222F',text_color='white'),
        ],
        [sg.Text("ALERT DECODED", font=('Arial Bold', 14), size=(35, None),justification="left",background_color='#10111A'),
         sg.Text("HTTP2 STREAMS", font=('Arial Bold', 14),justification="left",background_color='#10111A'),
         sg.Text("TCP STREAMS", font=('Arial Bold', 14),justification="left",background_color='#10111A'),
         sg.Text("HTTP OBJECTS", font=('Arial Bold', 14),justification="left",background_color='#10111A'),],
        [sg.Multiline(size=(60,20), key='-payloaddecoded-',background_color='#20222F',text_color='white'),
        sg.Listbox(key='-http2streams-', size=(20, 20), values=http2streams, enable_events=True,background_color='#20222F',text_color='white'),
        sg.Listbox(key='-tcpstreams-', size=(20,20), values=tcpstreams, enable_events=True,background_color='#20222F',text_color='white'),
        sg.Listbox(key='-httpobjects-', size=(20, 20), values=httpobjectindexes, enable_events=True,background_color='#20222F',text_color='white'),
        #sg.Multiline(size=(50,20), key='-payloaddecodedall-')
        ],
		[sg.Button('EXIT')]]

window = sg.Window('In-Sight', layout, size=(1600,800), resizable=True, background_color='#10111A')
